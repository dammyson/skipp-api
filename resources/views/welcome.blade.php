...
<head>
  ...
  <script>
    // var amount =  @json($amount);
     // Function to read the amount from the body attribute
    function getAmount() {
        return document.body.getAttribute('data-amount');
    }
    ...
    function payWithPaystack($amount) {
      var handler = PaystackPop.setup({
        ...
        callback: function(response) {
            ...
            // Send the reference to your Laravel API
            fetch(`/api/wallet/${reference}`, {
                method: 'GET',
                headers: {
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50" data-amount="{{ $amount }}">
  <form>
    <script src="https://js.paystack.co/v1/inline.js"></script>
    <button type="button" onclick="payWithPaystack(getAmount())"> Pay {{ $amount }}</button>
